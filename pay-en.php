...
<div class="flex flex-col md:flex-row bg-white p-6 border border-gray-300 rounded-lg shadow-lg max-w-4xl mx-auto gap-4 ">
  ...
  <div class=" md:pl-8 mt-6 md:mt-0 ml-2">
    ...
    <h3 class="text-xl font-semibold text-blue-600 mb-2">Let us Go - From Local to Global </h3>
    <p class="text-lg font-medium text-red-500 mb-2">for Just 9.5 USD</p>
    <p class="text-lg text-gray-700 mb-2">for Global Businessmen </p>
